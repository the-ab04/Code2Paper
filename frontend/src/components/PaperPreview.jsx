export default function PaperPreview({ url }){
  ...
  return (
    <div className="glass rounded-2xl p-6 md:p-8 mt-6">
      <h3 className="text-lg font-semibold mb-3">Your PDF is ready</h3>
      <div className="flex items-center gap-3">
        ...
        <span className="text-slate-400 text-sm">If it doesn’t open, right–click → Save link as…</span>
      </div>
      <div className="mt-5 rounded-xl overflow-hidden border border-slate-700/40">
        <iframe src={url} className="w-full h-[70vh] bg-slate-950"></iframe>
      </div>
    </div>
  );
}
